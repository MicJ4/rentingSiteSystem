...
>
    <div>
        <span class="rForm" id="rForm1" style="height:400px;">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <center><i>Please fill the form below:</i></center>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO userDetails (firstName, lastName, username , passwords ,cityTown, phone)
                VALUES ('$firstName', '$lastName', '$username','$passwords','$cityTown', '$phone')";
